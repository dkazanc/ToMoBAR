% A demo script to generate and reconstruct 3D sythetic parallel-beam data.
...
pathtoModels = sprintf(['..' fsep 'supplementary' fsep 'TomoPhantom' fsep 'functions' fsep 'models' fsep 'Phantom3DLibrary.dat'], 1i);
...
anglesRad = linspace(0,pi,anglesNumb); % projection angles
...
%%
fprintf('\n %s\n', 'Generating projection data using ASTRA toolbox...');

proj_geom = astra_create_proj_geom('parallel3d', 1.0, 1.0, N, Detectors, anglesRad);
