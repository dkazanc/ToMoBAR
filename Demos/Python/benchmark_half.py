...
def run_benchmark(iterations=10, warmup=1):
    ...
    Args:
        func: Callable to execute (must be pickle-able if using multiprocessing)
...
def benchmark(iterations=10, warmup=1):
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            return run_benchmark(run_once, iterations, warmup)
        return wrapper
    return decorator
