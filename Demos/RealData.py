...
for projector in ("astra", "fourier"):
    ...
    # %%
    print("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    print(f"Reconstructing with CGLS method ({projector} projector)")
    print("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    ...
    plt.title(f"CGLS reconstruction ({projector} projector)")
    plt.show()
    # %%
    print("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    print(f"Reconstructing with SIRT method ({projector} projector)")
    print("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    ####################### Creating the data dictionary: #######################
    _data_ = {
        "projection_data": data_norm_cupy,  # Normalised projection data
    ...
    plt.title(f"SIRT reconstruction ({projector} projector)")
    plt.show()
    # %%
    print("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    print(f"Reconstructing with FISTA OS-PWLS-TV (PD) method ({projector} projector)")
    print("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    ####################### Creating the data dictionary: #######################
    RectoolsCuPy = RecToolsIRCuPy(
        DetectorsDimH=detectorHoriz,  # Horizontal detector dimension
    ...
    Run_time = toc - tic
    print(
        "FISTA OS-TV reconstruction ({}) done in {} seconds".format(projector, Run_time)
    )

    fig = plt.figure()
    plt.imshow(cp.asnumpy((RecFISTA_os_tv[3, :, :])), vmin=0, vmax=0.003, cmap="gray")
    plt.title(f"FISTA OS-TV (PD) reconstruction ({projector} projector)")
    plt.show()
    # fig.savefig('dendr_PWLS.png', dpi=200)
    # %%
    print("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    print(f"Reconstructing with ADMM OS-PWLS-TV (PD) method ({projector} projector)")
    print("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    ...
    Run_time = toc - tic
    print(
        "ADMM-OS-TV (PD) reconstruction ({}) done in {} seconds".format(
            projector, Run_time
        )
    )
    ...
    plt.title(f"ADMM OS-TV (PD) reconstruction ({projector})")
    plt.show()
