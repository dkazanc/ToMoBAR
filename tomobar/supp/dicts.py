...
def dicts_check(self, 
    ...
    Args:
        ----------------------------------------------------------------------------------------------------------
        _data_ (dict):  Data dictionary inspects the following parameters:
        ...
        _algorithm_ (dict, optional): Algorithm dictionary inspects the following parameters. Defaults to {}.
            ...
            --nonnegativity # False (default), True enables the nonnegativity for algorithms
        ...
        ----------------------------------------------------------------------------------------------------------
        _regularisation_ (dict, optional): Regularisation dictionary inspects the following parameters. Defaults to {}.
    ...
    if method_run == "FISTA":
        if (_data_.get("beta_SWLS") is None) and (self.datafidelity == 'SWLS'):
